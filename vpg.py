...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_episode', default=10, type=int, help='number of episodes/iteration')
    parser.add_argument('--path_length', default=1000, type=int, help='number of steps')
    parser.add_argument('--learning_rate', default=0.03, help='learning rate for Adam Optimizer')
